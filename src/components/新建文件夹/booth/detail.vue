...
import $ from 'jquery'
import {api_url, mainProjectId, mainPassKey, mainUserTk, boothClassifyToList, commonAjaxFun, filterCurrentModule, filterDataImg} from '../../common/js/common.js'
    ...
    methods: {
        ...
        getBoothData: function(){
            ...
            commonAjaxFun({
                ...
                _this.dataAllNum = data.total;
                for(let i in data.rows){
                    _this.dataList.push(data.rows[i])
                }
        ...
        getBoothProduct: function(){
            ...
            commonAjaxFun({
                ...
                _this.productAllNum = data.pageObj.total;
                for(let i in data.pageObj.rows){
                    _this.productList.push(data.pageObj.rows[i])
                }
            })
        },
        boothBasicInfro: function(){
            ...
            commonAjaxFun({
                ...
                _this.boothData = data.data;
                _this.bannerUrl = `url(${this.boothData.boothFigure || this.boothData.meetingKv}`;
                _this.allDataModule = data.modules;
                _this.hotProductList = data.hotProduct;//热门产品
